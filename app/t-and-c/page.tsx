...
const termsAndConditions = [
  ...
  "Payment and Billing: All fees for services must be paid in full as per the agreed-upon quotation. Payments are non-refundable unless otherwise stated. Heireach Media reserves the right to suspend services if payment is not received on time.",
...
export default function TermsAndConditions() {
  ...
  return (
    <div className="min-h-96 px-24">
      <div className="flex mt-9 pb-16 justify-center align-middle font-amazingSlab font-extrabold text-[40px] text-[--primary-color]" >
        Terms & Conditions
      </div>
      <div className="font-amazingSlab">
