...
export default function Description(){
    ...
    return(
        <section id="about-us-description" className='bg-black font-amazingSlab pb-20 px-10'>
            ...
            <motion.div className="mb-12 pt-20 px-20 xs:px-0" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 4, ease: "easeOut" }}>
            ...
            {/* Our Vision & Mission */}
            <motion.div className="bg-[#0f0f0f] relative text-white pb-10 px-6 md:px-16" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 8, ease: "easeOut" }}>
                <div className="grid relative md:grid-cols-3 gap-8 items-center text-center md:text-left">
                    ...
                    <h3 className="font-bold xs:text-center md:text-sm text-lg lg:text-lg lg:text-end ">Turning Ideas into Iconic Brands</h3>
